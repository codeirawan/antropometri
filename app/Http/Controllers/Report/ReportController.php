...
class ReportController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $message = Lang::get('Report') . ' \'' . $weighing->name . '\' ' . Lang::get('successfully created.');
    ...
    public function edit($id)
    {
        ...
        $weighing = Report::select('id')->findOrFail($id);
    ...
    public function update($id, Request $request)
    {
        ...
        $message = Lang::get('Report') . ' \'' . $weighing->name . '\' ' . Lang::get('successfully updated.');
        return redirect()->route('weighing.index')->with('status', $message);
    }
    ...
    public function destroy($id)
    {
        ...
        $message = Lang::get('Report') . ' \'' . $name . '\' ' . Lang::get('successfully deleted.');
        return redirect()->route('weighing.index')->with('status', $message);
    }
}